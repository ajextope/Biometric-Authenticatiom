...
namespace Biometric_Apps
{
	...
	*/
	...
	public class VerificationForm : Scaning
    {  
                ...
                for (int i = 0; i < lst.Count; i++)
                {
                        ...
                        if (enrol.TemplateStatus == DPFP.Processing.Enrollment.Status.Ready)
                        {
                            ...
                            if (result.Verified)
                            {
                                ...
                                fm.Hide();
                                frm.Show();
                            System.Diagnostics.Process.Start("http://localhost/attendancesystem");
                                break;
        ...
        public List<Bus_FingerPrints> getbyet()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from Finger", DbConnection.con);
